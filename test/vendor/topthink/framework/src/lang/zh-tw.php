...
return [
    ...
    'not support'                                               => '不支援',
    'database config error'                                     => '數據庫配置信息錯誤',
    ...
    'relation not support'                                      => '關聯不支援',
    'chunk not support order'                                   => 'Chunk不支援調用order方法',
    'route pattern error'                                       => '路由變量規則定義錯誤',
    'route behavior will not support'                           => '路由行為廢棄（使用中間件替代）',
    'closure not support cache(true)'                           => '使用閉包查詢不支援cache(true)，請指定緩存Key',
    ...
    'The queue was exhausted, with no response returned'        => '中間件隊列為空',
    // 驗證錯誤信息
